...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-_!amd)f58!f@(_kew5pw!rk%kw471qj)y%f$jhqmws@1zmbl52')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

# Определяем продакшен окружение
...
if os.environ.get("USE_S3", 'False') == 'True':
    ...
    print("S3: файлы в Timeweb Cloud")
else:
    MEDIA_URL = '/media/'
    STORAGES = {
        "default": {
    ...
    print("Media: файлы в папке media/")

# Настройки статики (удалите строку STATICFILES_STORAGE = ...)
STATIC_URL = '/static/'
